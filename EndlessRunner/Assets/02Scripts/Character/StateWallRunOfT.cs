...
public class StateWallRun<T> : StateBase<T> where T : Enum
{
        ...
        : base(stateMachine, machineState, canExecuteConditionMask, nextTarget)
    {
        ...
        _wallDetector_L = stateMachine.owner.transform.Find("WallDetector_L").GetComponent<WallDetector>();
        _wallDetector_R = stateMachine.owner.transform.Find("WallDetector_R").GetComponent<WallDetector>();
    }
