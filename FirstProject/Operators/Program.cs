...
namespace Operators
{
    internal class Program
    {
        ...
        //데이터 영역은 2개로 나뉜다 (BSS와 Data)
        //BSS 초기화 되지 않은 변수 (모든 비트 0)
        //Data 초기화된 변수
        ...
        static void Main(string[] args)
        {
            ...
            // 관계 연산
            // 같음, 다름, 크기 비교  연산자
            // 관계 연산자의 연산 결과가 참이면 true, 거짓이면 false 반환
            //===============================================
            ...
            // or
            // a와 b 둘 중 하나라도 true면 true 반환, 나머지 경우 false 반환
            Console.WriteLine(A | B);

            // and
            // a와 b 둘 다 true면 true 반환, 나머지 경우 false 반환
            Console.WriteLine(A & B);

            // xor
            // a와 b 둘 중 하나만 true면 true 반환, 나머지 경우 false 반환
            Console.WriteLine(A ^ B);
